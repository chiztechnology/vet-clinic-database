...
**Install and Run Postgress on your local computer**
**copy and paste the instrunctions in the `.sql files` in the repository to create and populate the database**
